...
const DashboardLayout = ({ user, grid }: LayoutProps) => {
    ...
    return (
        <div className="flex flex-col md:flex-row min-h-screen bg-gray-50">
            ...
            <div className={`
                fixed inset-y-0 left-0 z-50 w-64 xl:w-72 bg-white border-r border-gray-200 p-5 flex flex-col justify-between h-screen 
            ...
            `}>
                ...
                <div className="mt-6 md:mt-0">
                    <div className="hidden md:flex items-center mb-5 justify-center">
            ...
            <div className="flex-1 p-4 md:p-6 bg-gray-50 h-[calc(100vh-64px)] md:h-screen overflow-y-auto">
                <ErrorBoundary>
                    <Outlet />
                </ErrorBoundary>
            </div>
